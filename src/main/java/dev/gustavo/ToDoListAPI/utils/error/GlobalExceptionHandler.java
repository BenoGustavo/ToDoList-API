...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<Response<BadRequest400Exception>> handleBadRequestException(BadRequest400Exception ex) {
                Response<BadRequest400Exception> responseBody = new ResponseBuilder<BadRequest400Exception>()
                                .result("Bad Request!").error(ex.getCode(), ex.getMessage()).status(ex.getCode())
                                .build();
        ...
        public ResponseEntity<Response<Unauthorized401Exception>> handleUnauthorizedRequests(
                ...
                Response<Unauthorized401Exception> responseBody = new ResponseBuilder<Unauthorized401Exception>()
                                .result("Unauthorized").error(ex.getCode(), ex.getMessage()).status(ex.getCode())
                                .build();
        ...
        public ResponseEntity<Response<UsernameNotFoundException>> handleUsernameNotFoundException(
                ...
                Response<UsernameNotFoundException> responseBody = new ResponseBuilder<UsernameNotFoundException>()
                                .result("User not found").error(404, ex.getMessage()).status(404).build();
        ...
        public ResponseEntity<Response<MultipartException>> handleMultipartException(MultipartException ex) {
                Response<MultipartException> responseBody = new ResponseBuilder<MultipartException>()
                                .result("invalid multipart request, check the docs!").error(400, ex.getMessage())
                                .status(400).build();
        ...
        public ResponseEntity<Response<MissingPathVariableException>> handleMissingPathVarException(
                ...
                Response<MissingPathVariableException> responseBody = new ResponseBuilder<MissingPathVariableException>()
                                .result("Missing path variable, perhaps you forgot something on the url")
