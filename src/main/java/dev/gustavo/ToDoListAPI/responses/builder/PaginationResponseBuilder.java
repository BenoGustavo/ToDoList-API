...
import dev.gustavo.ToDoListAPI.responses.generic.PaginationResponse;
...
public class PaginationResponseBuilder<T> {
    ...
    public PaginationResponseBuilder<T> error(String code, String message) {
        response.setError(new dev.gustavo.ToDoListAPI.responses.generic.ResponseError(code, message));
        return this;
    }
